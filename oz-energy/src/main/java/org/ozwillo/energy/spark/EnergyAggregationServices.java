...
public class EnergyAggregationServices {
	...
	public void runAggregation() throws IOException, InterruptedException{
		...
		Process spark = new SparkLauncher(env)
				 ...
				 * See http://apache-spark-developers-list.1001551.n3.nabble.com/SparkLauncher-setJavaHome-does-not-set-JAVA-HOME-in-child-process-td14848.html
			    ...
			    .setAppResource(mavenRepository + 
			    		"/average-by-day-and-customer-key/average-by-day-and-customer-key_2.10/1.0/average-by-day-and-customer-key_2.10-1.0-assembly.jar")
			    .setMainClass("AvgByDayAndCK").launch();
